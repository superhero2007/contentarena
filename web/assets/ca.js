...
ContentArena.Api = {
    ...
    getAllSports: function getAllSports() {
        var deferred = jQuery.Deferred();
        var _this = this;
        $.ajax({
