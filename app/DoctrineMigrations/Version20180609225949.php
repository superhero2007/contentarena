 ...
 */
class Version20180609225949 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE content ADD selected_rights_by_super_right LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:object)\'');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE content DROP selected_rights_by_super_right');
    }
}
