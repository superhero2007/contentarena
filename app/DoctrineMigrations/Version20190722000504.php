 ...
 */
class Version20190722000504 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE company ADD CONSTRAINT FK_4FBF094F98260155 FOREIGN KEY (region_id) REFERENCES territory (id)');
    }
