...
import {
    IconYellowCircle, minusIcon, minusYellowIcon, pencilIcon, reloadIcon, Spinner,
    trashIcon
        ...
        return (
            <div className="terms-edit-item">
                ...
                <div className="terms-edit-item-actions" >
                    ...
                    {!editing && custom && <IconYellowCircle icon={minusIcon} onClick={() => this.setState({showRemoveConfirm: true})}/>}
