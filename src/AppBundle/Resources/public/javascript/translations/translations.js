export const translations = {
  ...
  'en': {
    ...
    'PLEASE_SIGN_WITH_YOUR_CURSOR': 'Please sign with your cursor in the box below',
    ...
    'LISTING_DETAILS_PROGRAM_TITLE_DURATION': 'Episode Duration (min)',
    ...
    'Add Time': '',
    'Add date': 'Date of Action',
    'All fixture times are GMT; please ensure to use this time standard and not the local event time': '',
    'Year': 'Year',
    'To': 'To',
    ...
    'Season': 'Season',
    'Would you like to add specific fixture details to your listing? This is especially important if you sell single matches (e.g. friendly matches) or rounds.': '',
    'CL_STEP1_ADD_FIXTURES': 'Add fixtures',
    'CL_STEP1_ADD_SEASON': 'Add season',
    'Popular': 'Popular',
    'CL_STEP1_SELECTOR_ADD_SPORT': 'Add sport',
    'CL_STEP1_SELECTOR_ADD_SEASON': 'Add season',
    'CL_STEP1_SELECTOR_ADD_TOURNAMENT': 'Add competition',
    'CL_STEP1_SELECTOR_COUNTRIES_ALL': 'Select from country list',
    'Apply': 'Apply',
    'Contact': 'Contact',
    ...
    'CL_STEP1_LABEL_IMAGE': 'Listing image (opt.)',
    ...
    'CL_STEP2_PROGRAM_DURATION': 'Episode Duration (min)',
    ...
    'CL_STEP2_PROGRAM_DESCRIPTION': 'Edited Program Description',
