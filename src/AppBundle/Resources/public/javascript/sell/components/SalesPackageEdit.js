...
class SalesPackageEdit extends React.Component {
  constructor(props) {
    ...
    applySelection = () => {
      ...
      const allTerritories = Object.values(ContentArena.Data.Countries).map((i, k) => ({ value: i.name, label: i.name }));
                  ...
                  <div className="content">
                    ...
                    >
                      <div className="title">
                        ...
                        {" "}
Installment(s)
                        <input onChange={(e) => { this.setInstallmentValue(e.target.value, i); }} style={{ height: "26px", width: "70px" }} type="number" max={100} value={installment.value} />
                        {" "}
% of payment
                      </div>
