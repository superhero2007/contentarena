			...
			<div className="base-full-input">
				...
				<div className="content">
					<div
						className="item"
						onClick={() => {
							this.props.onUpdate(this.instant);
						}}
					>
						...
						<div className="description">
							...
							not possible to sell content via bidding process (for now). Further, the buyer can not be
					...
					<div
						className="item"
						onClick={() => {
							this.props.onUpdate(this.installments);
						}}
					>
