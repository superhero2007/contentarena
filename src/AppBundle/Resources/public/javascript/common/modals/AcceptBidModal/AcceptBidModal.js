...
class AcceptBidModal extends Component {
  ...
  componentWillUnmount() {
    ...
    handleAcceptBid = () => {
      ...
      const {
        contentId, selectedBid, postAction, listingCustomId, onCloseModal,
      } = this.props;
    ...
    render() {
      const {
        isOpen, onCloseModal, selectedBid, validation,
      } = this.props;
      const {
        isFail, isLoading, signature, terms, signatureName, signaturePosition,
      } = this.state;
      ...
      return (
        <Modal isOpen={isOpen} className="modal-wrapper wide" style={GenericModalStyle} onRequestClose={onCloseModal}>
